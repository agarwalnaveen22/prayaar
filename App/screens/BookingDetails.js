          ...
          <View style={styles.cardTextContainer}>
            ...
            <View style={styles.templeVistingDetails}>
              <View style={styles.labelTextContainer}>
                ...
                <Text style={styles.textStyle}>
                  {moment(temple.date).format('DD-MM-YYYY')}
                </Text>
              </View>
              <View style={styles.labelTextContainer}>
                <Text style={styles.label}>Time</Text>
                <Text style={styles.textStyle}>
                  {moment(temple.time).format('hh:mm a')}
                </Text>
              </View>
              <View style={styles.labelTextContainer}>
                <Text style={styles.label}>Day</Text>
                <Text style={styles.textStyle}>
                  {moment(temple.date).format('dddd')}
                </Text>
              </View>
              <View style={styles.labelTextContainer}>
                <Text style={styles.label}>Ticket Price</Text>
                <Text style={styles.textStyle}>Rs.{temple.amount}/Person</Text>
              </View>
            ...
            <View style={{alignSelf: 'center'}}>
              ...
              <Text
                ...
                {`CGST (${taxVariables?.CGST}%) + CGST (${taxVariables?.SGST}%) = Rs.${temple?.tax}`}{' '}
              </Text>
            </View>
          </View>
        </View>
